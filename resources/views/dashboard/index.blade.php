                                                    ...
                                                    <table class="table table-striped" id="table" style="width: 50px">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ is_null($laptop['done_time']) ? '-' : \Carbon\Carbon::parse($laptop['done_time'])->format('j F, Y') }}</td>
                                                                <td>{{$laptop['teacher']}}</td>
                                                                <td><a href="/dashboard/edit/{{$laptop['id']}}"
                                                                        class="fas fa-pen text-dark btn"></a>
                                                                    <form action="{{ route('dashboard.delete', $laptop['id']) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button
